...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Text = L"ƒинамический список";
			...
			this->button3->Text = L"ƒинамический список2";
			...
			this->button4->Text = L"Ѕинарное дерево";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		{
			label9->Visible = true;
			label9->Text = "¬ведите все пол€ оценок";
